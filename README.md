...
## Shiny Application
In the branch shiny_app_applied_config: The updated version with an end-to-end shiny application is location. Run app.py with ```python -m shiny run --reload app.py``` 
